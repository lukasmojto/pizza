...
import { customerRegisterAction, googleSignInAction } from '@/actions/customer-auth'
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-16">
      <div className="mb-8 text-center">
        ...
        <h1 className="mt-4 text-2xl font-bold text-gray-900">Registrácia</h1>
        <p className="mt-2 text-gray-500">Vytvorte si účet pre rýchlejšie objednávanie</p>
      </div>
      ...
      <Card>
        <CardContent>
          ...
          {state?.success ? null : <form action={formAction} className="space-y-4">
            <div>
